          ...
          <table className="mentor-table">
            ...
            <tbody>
              {mentorLeaderboard.map((lb) => (
                <tr key={lb.rank}>
                  <td className="co-lb-rank">#{lb.rank}</td>
                  <td className="co-lb-name">{lb.name}</td>
                  <td className="co-lb-batch">{lb.batch}</td>
                  <td className="co-lb-points">{lb.points} pts</td>
                  <td className="co-lb-solved">{lb.solved}</td>
                  <td>
