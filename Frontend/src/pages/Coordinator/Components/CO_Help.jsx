...
const kbGuides = [
  {
    title: "Department Coordinator Governance Manual",
    desc: "Complete guide on batch allocations, faculty assignments, attendance approvals, and system escalations.",
    size: "3.2 MB",
    type: "PDF Document"
  },
  {
    title: "Student Condonation & Exam Eligibility Rules",
    desc: "Official institutional rules governing 75% attendance compliance, medical overrides, and exam hall ticket generation.",
    size: "1.9 MB",
    type: "PDF Document"
  }
];
...
export default function CoordinatorHelp() {
  ...
  const [tickets, setTickets] = useState([
    {
      id: "TICK-9102",
      subject: "Request for new batch creation (CSE Sem 6 - Division C)",
      category: "Academics & Labs",
      priority: "High",
      created: "2026-09-11",
      status: "In Progress"
    ...
    {
      id: "TICK-8840",
      subject: "Trainer re-allocation for Systems Programming",
      category: "Account & Security",
      priority: "Normal",
      created: "2026-09-04",
      status: "Resolved"
