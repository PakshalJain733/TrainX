...
import { MessageSquare, CheckCircle2, Clock, AlertCircle, Search, Filter, ShieldCheck, UserCheck, X, Check, Send } from "lucide-react";
...
const initialTickets = [
  {
    id: "TKT-ADM-101",
    title: "Attendance discrepancy in Operating Systems Lecture on Sept 3rd",
    requesterName: "Siddharth Rao",
    role: "Student",
    batch: "TE-IT-2026-B",
    ...
    status: "Open",
    time: "2 hours ago",
    description: "I scanned the attendance QR code during OS lecture at 10:15 AM, but portal marks me Absent. Requesting manual verification from logs."
  },
  {
    id: "TKT-ADM-102",
    title: "Lab 3 Linux Terminal access permissions failing for BE-CS-A",
    ...
    status: "In Progress",
    time: "4 hours ago",
    description: "Students in BE-CS-A cannot execute gcc compiler on Lab Server 03 due to permission denial. Need admin sudo permission fix."
  },
  {
    id: "TKT-ADM-103",
    title: "Request for reassessment of Microprocessor Practical Exam",
    ...
    status: "Open",
    time: "1 day ago",
    description: "Code logic output in Viva was verified by lab assistant, but marks show 12/25. Kindly review answer sheet recording."
  },
  {
    id: "TKT-ADM-104",
    title: "Extra lab slot approval for upcoming Aptitude Mock Test",
    requesterName: "Aniket Kadam",
    role: "Coordinator",
    ...
    status: "Resolved",
    time: "2 days ago",
    description: "Requesting allocation of Central Computer Center for 120 students on Saturday from 2 PM to 5 PM for TCS NQT mock test.",
    resolutionNote: "Approved Central Computer Center Lab 1 & 2 for Saturday 2:00 PM. Lab technicians notified."
  }
];
