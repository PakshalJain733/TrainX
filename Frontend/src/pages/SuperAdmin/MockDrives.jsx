      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {drives.length === 0 ? (
          <div className="col-span-full py-12 text-center text-slate-400 bg-white rounded-2xl border border-slate-200">
            <ClipboardCheck className="w-8 h-8 mx-auto mb-2 opacity-40 text-slate-400" />
            <p className="font-medium text-slate-600 text-sm">No placement mock drives scheduled.</p>
          </div>
        ) : (
          drives.map((d) => (
