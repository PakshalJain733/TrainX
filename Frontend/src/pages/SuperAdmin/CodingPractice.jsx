    ...
    <div className="p-6 space-y-6 text-slate-100 min-h-screen bg-[#090d16]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
          ...
          <div className="text-2xl font-extrabold text-white mt-1">{globalPlatformStats.totalProblems}</div>
        </div>
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
          <div className="text-xs text-slate-400 font-semibold">Total Submissions</div>
          <div className="text-2xl font-extrabold text-indigo-400 mt-1">{globalPlatformStats.totalSubmissions}</div>
        </div>
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
          <div className="text-xs text-slate-400 font-semibold">Platform Accuracy</div>
          <div className="text-2xl font-extrabold text-emerald-400 mt-1">{globalPlatformStats.accuracyRate}</div>
        </div>
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
          <div className="text-xs text-slate-400 font-semibold">Active Coders</div>
          <div className="text-2xl font-extrabold text-amber-400 mt-1">{globalPlatformStats.activeCoders}</div>
        </div>
        <div className="bg-slate-900/80 border border-slate-800 p-4 rounded-xl">
          <div className="text-xs text-slate-400 font-semibold">Top Language</div>
          <div className="text-2xl font-extrabold text-purple-400 mt-1">{globalPlatformStats.topLanguage}</div>
        </div>
      </div>
